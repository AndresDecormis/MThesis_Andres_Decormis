...
def main():
    ...
    other_notes             = '-AltCons-Bench-HP225-NoTESAtAll-NoH2+slack'                # Notes to be added on the folder version name
    ...
    use_electrolyser        = False              # Use electrolyser in the model
    use_fuel_cell           = False              # Use fuel cell in the model
    hydrogen_connection     = False              # Use hydrogen connection in the model
